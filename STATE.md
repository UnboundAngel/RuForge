...
Last updated: 2026-08-02 (Chapter scrubber knob left-offset fix in 0.2.3 tree)
...
- Player: Video end screen on main and mini with unwatched-first suggestions and Up next countdown. Chapter scrubber knob tracks the pointer again (no double horizontal translate).
