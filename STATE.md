...
- Download queue: duplicate auto-skip and queue removal stop active yt-dlp before hiding rows; paused events no longer overwrite skipped rows; near-100% downloads use processing idle budgets; Unix pause/stop also targets direct child processes.
