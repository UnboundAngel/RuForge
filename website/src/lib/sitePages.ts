...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    id: 'docs',
    label: 'Docs',
    description: 'Reference documentation for settings and internals.',
    pages: [
      {
        slug: 'overview',
        title: 'Documentation',
        description: 'Index of reference pages for RuForge settings and behavior.',
        outline: ['How to read these docs', 'Sections', 'Contributing docs'],
      },
      {
        slug: 'built-with',
        title: 'Built with',
      ...
      },
      {
        ...
        outline: ['General', 'Downloads', 'Playback', 'Debugging'],
      },
      {
        slug: 'download-options',
        title: 'Download options',
        description: 'Formats, audio-only, cookies, auto previews, and queue behavior.',
        outline: ['Format strings', 'Cookies', 'Previews', 'Queue limits'],
      },
      {
        slug: 'playback',
        title: 'Playback',
        description: 'Volume, chapters, auto-advance, prefetch, and mini player handoff.',
        outline: ['Output state', 'Chapters', 'Mini sync', 'Persistence'],
      },
      {
        ...
        outline: ['Master toggle', 'Categories', 'Sidecar', 'API'],
      },
      {
        slug: 'explorer-setup',
        title: 'Explorer setup',
        description: 'Bounds, navigation chrome, and cookie flows for yt-dlp.',
        outline: ['Child webview', 'Title bar nav', 'Bounds sync', 'Cookies'],
      },
      {
        slug: 'build-from-source',
        title: 'Build from source',
        description: 'Clone, npm, Tauri dev, and signed Windows build notes.',
        outline: ['Prerequisites', 'Dev command', 'Signed build', 'Binaries'],
      },
      {
        slug: 'contributing',
        title: 'Contributing',
        description: 'Code style, Shipped log, and release expectations for contributors.',
        outline: ['Pull requests', 'AGENTS.md', 'STATE.md', 'No emdashes rule'],
      },
    ],
  },
];
