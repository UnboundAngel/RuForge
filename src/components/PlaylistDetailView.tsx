    ...
    >
      ...
      <div className="relative w-full md:w-[460px] lg:w-[520px] flex flex-col flex-shrink-0 px-6 pt-6 z-10 bg-[#1D1613]">
        ...
        >
          ...
          <div className="relative h-full p-8 pb-32 flex flex-col gap-8 overflow-y-auto scrollbar-none z-10">
            <button 
              onClick={onBack}
      ...
      <div className="flex-1 overflow-y-auto p-10 scrollbar-none bg-[#1D1613]">
